/*
 This is the generic message creation logic for ChangeExtVnfConnectivityRequest messages based on the 2.4.1 version of the ETSI SOL003 specification
 */
logger.debug('Generating ChangeExtVnfConnectivityRequest message for ETSI SOL003 v2.4.1');
