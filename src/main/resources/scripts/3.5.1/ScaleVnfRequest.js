/*
 This is the generic message creation logic for ScaleVnfRequest messages based on the 3.5.1 version of the ETSI SOL003 specification
 */
logger.debug('Generating ScaleVnfRequest message for ETSI SOL003 v3.5.1');
