...
public class LoggingRequestInterceptor implements ClientHttpRequestInterceptor {
    ...
    @Autowired
    public LoggingRequestInterceptor(VNFMDriverProperties vnfmDriverProperties) {
        super();
    ...
    private void traceResponse(ClientHttpResponse response) throws IOException {
        ...
        InputStream boundedInputStream = new BoundedInputStream(response.getBody(), vnfmDriverProperties.getLogging().getLoggingRequestInterceptMaxBodySize());
