...
public class PackageManagementController {
    ...
    @Operation(operationId = "Query VNF packages information.", description = "Queries the information of the VNF packages matching the filter.")
    ...
    @Operation(operationId = "Reads the information of an individual VNF package", description = "This resource represents an individual VNF package. The client can use this resource to read information of the VNF package.")
    ...
    @Operation(operationId = "Reads the content of the VNFD within a VNF package.", description = "This resource represents the VNFD contained in an on-boarded VNF package. The client can use this resource to obtain the content of the VNFD.")
    ...
    @Operation(operationId = "Reads the content content of an artifact within a VNF package.", description = "This resource represents an individual artifact contained in a VNF package. The client can use this resource to fetch the content of the artifact.")
