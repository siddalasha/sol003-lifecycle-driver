...
public class VnfInfoModifications {
    ...
    @ApiModelProperty(name = "Onboarded VNF Package Information Id", notes = "New value of the \"onboardedVnfPkgInfoId\" attribute in \"VnfInstance\". The value \"null\" is not permitted.")
