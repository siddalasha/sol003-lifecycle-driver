...
public abstract class AbstractVNFPackageRepositoryDriver implements VNFPackageRepositoryDriver {

    private final static Logger logger = LoggerFactory.getLogger(AbstractVNFPackageRepositoryDriver.class);

    protected final VNFMDriverProperties vnfmDriverProperties;

    @Autowired
    public AbstractVNFPackageRepositoryDriver(VNFMDriverProperties vnfmDriverProperties) {
