...
public class VnfInstance {
    ...
    public static class InstantiatedVnfInfo {
        ...
        @Schema(name = "Max Scale Levels", description = "Maximum allowed scale levels of the VNF, one entry per aspect.")
        ...
        @Schema(name = "vip CP Info", required = true, description = "Information about the external CPs exposed by the VNF instance.")
        ...
        @Schema(name = "Metadata", description = "Additional VNF-specific attributes that provide metadata describing the VNF instance.")
        private Map<String, String> metadata;
        @Schema(name = "Extensions", description = "Additional VNF-specific attributes that affect the lifecycle management of this VNF instance.")
        private Map<String, String> extensions;
    ...
    public static class Links {
        ...
        @Schema(name = "createSnapshot", description = "Link to the \"Create VNF snapshot task\" task resource, if the related operation is possible based on the current status of this VNF instance resource (i.e. VNF instance is in INSTANTIATED state).")
        private Link createSnapshot;
        @Schema(name = "revertToSnapshot", description = "Link to the \"Revert to VNF snapshot task\"  resource, if the related operation is possible based on the current status of this VNF instance resource (i.e. VNF instance is in INSTANTIATED state).")
    ...
    @JsonInclude(value = JsonInclude.Include.NON_EMPTY, content = JsonInclude.Include.NON_NULL)
    @JsonIgnoreProperties(ignoreUnknown = true)
    @Schema(description = "Information about related to virtual IP (VIP) CP.")
    public static class VipCpInfo {

        @Schema(name = "cp Instance Id", required = true, description = "Identifier of this VIP CP instance and of this VipCpInfo information element.")
        private String cpInstanceId;
        @Schema(name = "External CPD Id", required = true, description = "Identifier of the VIP Connection Point Descriptor, VipCpd, in the VNFD.")
        private String cpdId;
        @Schema(name = "vnfExtCpId",description = "When the VIP CP is exposed as external CP of the VNF, the identifier of this external VNF CP instance.")
        private String vnfExtCpId;
        @Schema(name = "CP Protocol Information", description = "Protocol information for this CP. There shall be one cpProtocolInfo for layer 3. There may be one cpProtocolInfo for layer 2.")
        private List<CpProtocolInfo> cpProtocolInfo;
        @Schema(name = "Associated Vnfc CpIds", description = "Identifiers of the VnfcCps that share the virtual IP addresse allocated to the VIP CP instance.")
        private List<String> associatedVnfcCpIds;
        @Schema(name = "VNF  Link Port Id", description = "Identifier of the \"VnfLinkPortInfo\" structure in the \"VnfVirtualLinkResourceInfo\" or \"ExtManagedVirtualLinkInfo\" structure. Shall be present if the CP is associated to a link port on an internal VL.")
        private String vnfLinkPortId;
        @Schema(name = "Metadata", description = "Metadata about this VIP CP.")
        private Map<String, String> metadata;
